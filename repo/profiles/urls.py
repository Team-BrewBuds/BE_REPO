...
urlpatterns = [
    ...
    path("login/oauth/apple/", views.AppleCallbackView.as_view(), name="naver_callback"),
    path("login/apple/finish/", views.AppleLoginView.as_view(), name="naver_login_todjango"),
