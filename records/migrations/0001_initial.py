    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_cnt', models.ManyToManyField(related_name='like_tasted_records', to='profiles.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='작성일')),
                ('tag', models.TextField(null=True, verbose_name='태그')),
                ('like_cnt', models.ManyToManyField(related_name='like_posts', to='profiles.user')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.user', verbose_name='작성자')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tasted_record', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='records.tasted_record', verbose_name='시음 기록')),
            ],
            options={
                'verbose_name': '노트',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='작성일')),
                ('like_cnt', models.ManyToManyField(related_name='like_comments', to='profiles.user')),
                ('parent_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='replies', to='records.comment', verbose_name='상위 댓글')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.user', verbose_name='작성자')),
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='records.post', verbose_name='게시글')),
                ('tasted_record', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='records.tasted_record', verbose_name='시음 기록')),
            ],
